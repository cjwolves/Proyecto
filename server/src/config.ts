...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'BuildingCop';
    ...
    'jhipster.mail.from' = 'BuildingCop@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'BuildingCop API';
    'jhipster.swagger.description' = 'BuildingCop API documentation';
    ...
    'eureka.instance.appname' = 'BuildingCop';
    'eureka.instance.instanceId' = 'BuildingCop:${random.value}';
